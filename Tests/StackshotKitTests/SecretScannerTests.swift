...
@Suite struct SecretScannerTests {
    ...
    @Test func findsCommonKeysAndTokens() {
        let text = "key sk-ant-api03-abcdefghijklmnopqrstuv and ghp_abcdefghijklmnopqrstuvwxyz0123456789 AKIAABCDEFGHIJKLMNOP"
    ...
    @Test func findsASecretInAnImage() async throws {
        ...
        let image = NSImage(size: size, flipped: false) { rect in
            ...
            rect.fill()
            ("export OPENAI_API_KEY=sk-proj-Zx81kLmQ2vRt7yUi9oPaSdFgHjKl" as NSString).draw(
