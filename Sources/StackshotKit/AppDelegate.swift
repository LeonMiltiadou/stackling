...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private func setUpStatusItem() {
        ...
        statusItem.button?.image = NSImage(systemSymbolName: Self.stackSymbol, accessibilityDescription: "Stackshot")
    ...
    private func showRecordingIcon(_ recording: Bool) {
        ...
        if recording {
            ...
            button.image = NSImage(systemSymbolName: Self.stackSymbol, accessibilityDescription: "Stackshot")
        }
    }
    ...
    /// Registers the capture shortcuts. ⇧⌘4 is Stackshot's by default (frozen screen and loupe),
    ...
    private func applyShortcuts() {
        ...
        Log.keys.notice("shortcuts.applied area=\(takeOver ? "stackshot" : "macos", privacy: .public)")
    }
}
